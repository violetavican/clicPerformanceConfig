...
from Configurables import LcioEvent, k4DataSvc, MarlinProcessorWrapper, GaudiDDPlanarDigiProcessor
...
evtsvc.input = '/home/vvicente/ws/CLICPerformance/clicConfig/ttbar_edm4hep.root'
...
CLICPfoSelectorTight_LE.Parameters = {
                                      ...
                                      "Neutsource /cvmfs/sw.hsf.org/spackages6/key4hep-stack/2022-08FarForwardLooseTimingCut": ["2"],
                                      "PhotonFarForwardTightTimingCut": ["1"],
...
# DDPlanarDigiProcessor initialization
DDPlanarDigiProcessor = GaudiDDPlanarDigiProcessor("myDDPlanarDigiProcessor")
#DDPlanarDigiProcessor.theMessage = "Hey there"
DDPlanarDigiProcessor.ProcessorType = "DDPlanarDigiProcessor"
DDPlanarDigiProcessor.IsStrip = False
# this is not the original default input from DDPlanarDigiprocessor
DDPlanarDigiProcessor.ResolutionU = [0.003] * 6
DDPlanarDigiProcessor.ResolutionV = [0.003] * 6
DDPlanarDigiProcessor.ResolutionT = [-1, -1, -1, -1, -1, -1]
DDPlanarDigiProcessor.SubDetectorName = "Vertex"
DDPlanarDigiProcessor.InputCollections = "VertexBarrelCollection"
DDPlanarDigiProcessor.OutputCollection = "VXDTrackerHitRelations"#, "VTXTrackerHitRelations"
DDPlanarDigiProcessor.ForceHitsOntoSurface = False
DDPlanarDigiProcessor.MinimumEnergyPerHit = 0.0
DDPlanarDigiProcessor.CorrectTimesForPropagation = False
DDPlanarDigiProcessor.UseTimeWindow = False
DDPlanarDigiProcessor.TimeWindowMin = [-1e9]
DDPlanarDigiProcessor.TimeWindowMax = [ 1e9]


""" VXDBarrelDigitiser.Parameters = {
                                 "IsStrip": ["false"],
                                 "ResolutionU": ["3", "3", "3", "3", "3", "0.003"],
                                 "ResolutionV": ["0.003", "0.003", "0.003", "0.003", "0.003", "0.003"],
                                 "SimTrackHitCollectionName": ["VertexBarrelCollection"],
                                 "SimTrkHitRelCollection": ["VXDTrackerHitRelations"],
                                 "SubDetectorName": ["Vertex"],
